...
public class FriendshipAdapter implements FriendshipRepository {
    ...
    private final SpringDataMongoFriendshipRepository repository;
    ...
    public Friendship save(Friendship friendship) {
        FriendshipMongoEntity friendshipMongoEntity = mapper.toMongoEntity(friendship);
        FriendshipMongoEntity savedEntity = repository.save(friendshipMongoEntity);
